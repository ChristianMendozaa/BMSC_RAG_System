...
MODELS_TO_TEST = [
    {
        ...
        "filename": "Qwen_Qwen3-4B-Q8_0.gguf",
    },
    {
        "nombre": "Qwen2.5-1.5B-Instruct (Q8)",
        "repo_id": "bartowski/Qwen2.5-1.5B-Instruct-GGUF",
        "filename": "Qwen2.5-1.5B-Instruct-Q8_0.gguf",
    },
    {
        "nombre": "Llama-3.2-1B-Instruct (Q8)",
        "repo_id": "bartowski/Llama-3.2-1B-Instruct-GGUF",
        "filename": "Llama-3.2-1B-Instruct-Q8_0.gguf",
    },
    {
        "nombre": "Llama-3.2-3B-Instruct (Q8)",
        "repo_id": "bartowski/Llama-3.2-3B-Instruct-GGUF",
        "filename": "Llama-3.2-3B-Instruct-Q8_0.gguf",
    },
    {
        "nombre": "DeepSeek-V2-Lite-Chat (16B MoE - Q8)",
        "repo_id": "mradermacher/DeepSeek-V2-Lite-Chat-GGUF",
        "filename": "DeepSeek-V2-Lite-Chat.Q8_0.gguf",
    },
]
